...
<form action="" name="employee_form" method="post" onsubmit="return ValidateContactForm();" enctype="multipart/form-data">
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			...
			<td><input type="text" name="employee_name"autofocus="autofocus" class="inp-form-error" /></td>
<!--			<td>
...
<!--			<td><input type="radio" name="patient_gender"  value="male" /> Male</td> 
		...
		<td><textarea name="employee_description" rows="" cols="" class="form-textarea"></textarea></td>
		<td></td>
	       </tr>
               
               <tr>
			<th valign="top">Address:</th>
                        <td><textarea name="employee_address" rows="" cols="" class="form-textarea"> </textarea> </td>
			<td></td>
		</tr>
                
                 <tr>
			<th valign="top">Contact No:</th>
                        <td><input type="text" name="employee_contact" class="inp-form" /></td>
			<td></td>
		</tr>
			...
			<th valign="top">Duty time:</th>
                        <td><input type="text" name="employee_duty_time" class="inp-form" /> </td>
			<td></td>
		</tr>
		...
		<th valign="top"> Joining Date:</th>
                		...
                		<td><input type="text" id="date-pick" name="employee_joining_date"  class="inp-form" ></td>
<!--
		<td class="noheight">
